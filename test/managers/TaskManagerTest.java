...
abstract class TaskManagerTest<T extends TaskManager> {
    ...
    public void subtasksShouldNotContainDeletedSubtaskIsTest() {//Удаляемые подзадачи не должны хранить внутри себя старые id.
        ...
        assertThrows(NotFoundException.class, () -> taskManager.getSubtaskById(subtaskIdToDelete));
    }
    ...
    public void isTaskCrossTest() {
        ...
        assertThrows(HasInteractionsException.class, () -> taskManager.updateTask(task2));
